...
2. Without a camera, orbit and select nodes with the mouse; the detail panel should show the title and three tabs.
3. Click **Enable camera** and allow camera permission.
4. Extend the index finger and move it: the screen-space Pointer should move over nodes.
